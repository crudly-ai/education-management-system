...
import { TeacherCreateModalProps } from './types';

export function TeacherCreateModal({ open, onOpenChange, ...props }: TeacherCreateModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/teachers', {
            ...
            onError: () => {
                toast.error(t('Failed to create teacher'), { description: t('Please check the form and try again') });
            },
        });
    };
        ...
        <Modal open={open} onOpenChange={handleClose}>
            <ModalContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                <form onSubmit={handleSubmit}>
                    <ModalHeader>
                        <ModalTitle>{t('Create Teacher')}</ModalTitle>
                    </ModalHeader>
