...
import { SubjectCreateModalProps } from './types';

export function SubjectCreateModal({ open, onOpenChange, ...props }: SubjectCreateModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/subjects', {
            ...
            onError: () => {
                toast.error(t('Failed to create subject'), { description: t('Please check the form and try again') });
            },
        });
    };
        ...
        <Modal open={open} onOpenChange={handleClose}>
            <ModalContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                <form onSubmit={handleSubmit}>
                    <ModalHeader>
                        <ModalTitle>{t('Create Subject')}</ModalTitle>
                    </ModalHeader>
