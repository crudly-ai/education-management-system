...
import { SubjectViewModalProps } from './types';

export function SubjectViewModal({ open, onOpenChange, subject, onEdit }: SubjectViewModalProps) {
    ...
    return (
        <Modal open={open} onOpenChange={onOpenChange}>
            <ModalContent className="sm:max-w-[800px]">
                <ModalHeader>
                    <ModalTitle>{t('Subject Details')}</ModalTitle>
                </ModalHeader>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900">
                                {subject.description || t('No description provided')}
                            </p>
                        </div>
