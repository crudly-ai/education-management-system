...
import { ClassViewModalProps } from './types';

export function ClassViewModal({ open, onOpenChange, classData, onEdit }: ClassViewModalProps) {
    ...
    return (
        <Modal open={open} onOpenChange={onOpenChange}>
            <ModalContent className="sm:max-w-[800px]">
                <ModalHeader>
                    <ModalTitle>{t('Class Details')}</ModalTitle>
                </ModalHeader>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900">
                                {classData.description || t('No description provided')}
                            </p>
                        </div>
