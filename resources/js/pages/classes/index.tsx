...
import { ClassCreateModal } from './create';
import { ClassEditModal } from './edit';
import { ClassViewModal } from './view';
import { ClassIndexProps } from './types';
...
export default function Index(props: ClassIndexProps) {
    ...
    const renderGridItem = (classData: any) => (
                ...
                <div className="space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 className="font-semibold text-gray-900 truncate text-sm leading-tight">
                                {classData.name || `Class #${classData.id}`}
                            </h3>
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                            {customRowActions(classData)}
                        </div>
                    </div>
                    
                    <div className="space-y-2">
                        <div className="flex flex-wrap gap-1">
                            <Badge variant={classData.status === 'active' ? 'default' : 'secondary'} className="text-xs px-2 py-0.5 capitalize">
                                {classData.status}
                            </Badge>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500 pt-2 border-t">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <span>{formatDate(classData.created_at_formatted)}</span>
                        </div>
                    </div>
                </div>
            </CardContent>
            ...
            <div className="p-6">
                ...
                {hasPermission('view_class') && (
                    <ClassViewModal
                        ...
                        classData={selectedClass}
                        onEdit={hasPermission('edit_class') ? (classData) => {
                ...
                <ConfirmationDialog
                    ...
                    onConfirm={() => {
                        router.delete(`/classes/${selectedClass.id}`, {
                            ...
                            onError: () => {
                                toast.error(t('Failed to delete class'), { description: t('Please try again') });
                            },
                        });
                    }}
                />
