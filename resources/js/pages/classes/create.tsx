...
import { ClassCreateModalProps } from './types';

export function ClassCreateModal({ open, onOpenChange, ...props }: ClassCreateModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/classes', {
            ...
            onError: () => {
                toast.error(t('Failed to create class'), { description: t('Please check the form and try again') });
            },
        });
    };
        ...
        <Modal open={open} onOpenChange={handleClose}>
            <ModalContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                <form onSubmit={handleSubmit}>
                    <ModalHeader>
                        <ModalTitle>{t('Create Class')}</ModalTitle>
                    </ModalHeader>
